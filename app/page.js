      ...
      <div className='container mx-auto h-full '>
        <div className='flex flex-col justify-center items-center h-full xl:flex-row xl:pt-8 xl:pb-24 xl:justify-between'>
          ...
          <div className='text-center xl:text-left order-2 xl:order-none my-10'>
            ...
            <p className='text-lg max-w-[500px] mb-9 text-white/88'>I'm a software developer based in Pakistan, specializing in building (and occasionally designing) exceptional websites, applications, and everything in between.</p>
            {/* button and socials */}
